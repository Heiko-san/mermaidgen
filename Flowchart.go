...
// https://mermaidjs.github.io/mermaid-live-editor from it. May return a JSON
// encoding error.
func (fc *Flowchart) LiveURL() (url string, err error) {
	...
	return liveURL + base64.URLEncoding.EncodeToString(data), nil
}
